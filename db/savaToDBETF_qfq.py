...
def insert_data(fund_code, data):
    ...
    cur = conn.cursor()
    insert_query = """
    INSERT INTO etf_net_value_qfq (fund_code, net_value_date, open_value,close_value,high_value,low_value,amount,amount_value,amplitude,price_change,price_change_rate,turnover)
...
if __name__ == "__main__":
    ...
    for _, fund in fund_list.iterrows():
        ...
        try:
            ...
            # fund_open_fund_info_em_df = ak.fund_etf_fund_info_em(fund=fund_code, start_date="20000101", end_date="20500101")
            fund_open_fund_info_em_df = ak.fund_etf_hist_em(symbol=fund_code, period="daily", start_date="20000101", end_date="20500101", adjust="qfq")
