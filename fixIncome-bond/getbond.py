...
output_file = '基金持仓2022.xlsx'  # 输出文件名
...
# 基金历史数据-单位净值走势
fund_open_fund_info_em_df = ak.fund_open_fund_info_em(fund="000488", indicator="单位净值走势")
# 基金历史数据-累计净值走势
...
# 股票持仓
# fund_portfolio_hold_em_df = ak.fund_portfolio_hold_em(symbol="000002", date="2021")
# 债券持仓
...
# 基金经理变更
# fund_announcement_personnel_em_df = ak.fund_announcement_personnel_em(symbol="004685")
# 基金评级、基金行业配比
try:
    fund_open_fund_info_em_df.to_excel(output_path, index=False)
